...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form action="/dashboard/calon-penerima" method="post">
                @csrf
                ...
                <div class="mb-2">
                    ...
                    <input type="number" name="no_handphone" class="form-control @error('no_handphone') is-invalid @enderror" value="{{ old('no_handphone') }}">
                    @error('no_handphone')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
