...
<div class="container">
    ...
    <div class="row py-3">
        <div class="col-lg-12">
            <h3>Tambah data kriteria perilaku</h3>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form action="/dashboard/kriteria-perilaku" method="post">
                @csrf

                <div class="mb-2">
                    <label class="form-lable">Perilaku</label>
                    <input type="text" name="perilaku" class="form-control @error('perilaku') is-invalid @enderror" value="{{ old('perilaku') }}">
                    @error('perilaku')
