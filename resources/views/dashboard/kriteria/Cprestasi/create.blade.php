...
<div class="container">
    ...
    <div class="row py-3">
        <div class="col-lg-12">
            <h3>Tambah data kriteria prestasi akademik</h3>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <form action="/dashboard/kriteria-prestasi" method="post">
                @csrf

                <div class="mb-2">
                    <label class="form-lable">Prestasi akademik</label>
                    <input type="text" name="prestasi" class="form-control @error('prestasi') is-invalid @enderror" value="{{ old('prestasi') }}">
                    @error('prestasi')
